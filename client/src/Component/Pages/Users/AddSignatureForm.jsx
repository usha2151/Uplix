...
const AddSignatureForm = () => {
  ...
  return (
    <div className="px-16 py-8">
      ...
      <h2 className="text-fs4 font-semibold text-blue mb-1">Add Signature</h2>
      <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
        ...
        <div className="mb-1">
          <label htmlFor="position" className="block font-semibold mb-1">Position:</label>
          <input
            type="text"
            id="position"
            name="position"
      ...
      <div className="mt-6 flex justify-end mx-auto">
          <button type="submit" className=" py-2 px-4 bg-blue text-white rounded-md hover:bg-blue-700">Submit</button>
        </div>
      </div>
    </div>
  );
