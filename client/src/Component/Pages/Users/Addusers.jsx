    ...
    <div>
     ...
     <div className="bg-white p-5 rounded-lg relative">
       ...
       <form >
           ...
           <button className="inline-flex justify-center items-center mt-8 rounded-md border border-transparent bg-red-500 py-2 px-4 text-sm text-white font-medium bg-blue-500 h-8">Cancel</button>
           </div>
           </div>
        
         <div className="mt-4 flex justify-end gap-2">
           <button  className="inline-flex justify-center rounded-md border border-transparent bg-green py-2 px-4 text-sm text-white font-medium bg-blue-500"><i class="fa-solid fa-user-plus mr-1 mt-1"></i>Add Users</button>
         </div>
